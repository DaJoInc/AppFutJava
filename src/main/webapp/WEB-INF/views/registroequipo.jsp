...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container"
		ng-controller="RegistroEqController as ctrl">
				...
				<div class="container">
					<form ng-submit="ctrl.submit()">
						<div id="contact">
							...
							<fieldset>
								<input placeholder="Nombre de Equipo" type="text"
									ng-model="ctrl.userDto.nombreEquipo">
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<p
												...
												<button type="button" class="btn btn-default"
													data-dismiss="modal"
													onclick="javascript:location.href='${pageContext.request.contextPath}/registroequipo/'">Close</button>
											</p>
	...
	<script
		src="${pageContext.request.contextPath}/static/js/service/registroEq_service.js"></script>
	<script
		src="${pageContext.request.contextPath}/static/js/controller/registroEq_controller.js"></script>
