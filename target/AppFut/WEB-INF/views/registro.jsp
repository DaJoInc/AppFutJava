...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container"
				...
				<div class="bg-color">
					...
					<div class="container">
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="${pageContext.request.contextPath}">App<span class="logo-dec">Fut</span></a>
						</div>
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav navbar-right">
								<li class="active"><a
									href="${pageContext.request.contextPath}">Inicio</a></li>
								<li class=""><a href="${pageContext.request.contextPath}/ingreso">Ingreso</a></li>
							</ul>
						</div>
					</div>
					</nav> 
				...
				<div id="contact">
					...
					<fieldset>
						<input placeholder="Nombre" type="text"
							ng-model="ctrl.userDto.nombre" tabindex="1" required autofocus>
					</fieldset>

					<fieldset>
						<input placeholder="Apellido" type="text"
							ng-model="ctrl.userDto.apellido" tabindex="2" required autofocus>
					</fieldset>

					<fieldset>
						<input placeholder="Tipo de Documento" list="tipoDocumento"
							ng-model="ctrl.userDto.tipoDocumento" tabindex="3" required
							autofocus>
						...
						<input placeholder="Numero de Documento" type="number"
							ng-model="ctrl.userDto.documento" tabindex="4" required autofocus>
					</fieldset>

					<fieldset>
						<input placeholder="Fecha de Nacimiento" type="date"
							ng-model="ctrl.userDto.fechaNacimiento" tabindex="5" required>
					</fieldset>
					...
					<fieldset>
						<input placeholder="Rol de Usuario" list="rol"
							ng-model="ctrl.userDto.idRol" tabindex="8" required>
						<datalist id="rol">
						<option value="2">Directivo
						<option value="3">Jugador
						</datalist>
					</fieldset>
									...
									<div class="modal-header">
										...
										<p
											...
											<button type="button" class="btn btn-default"
												data-dismiss="modal"
												onclick="javascript:location.href='${pageContext.request.contextPath}'">Close</button>
										</p>
		...
		<script
			src="${pageContext.request.contextPath}/static/js/service/registro_service.js"></script>
		<script
			src="${pageContext.request.contextPath}/static/js/controller/registro_controller.js"></script>
</body>
