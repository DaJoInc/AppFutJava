...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container"
		ng-controller="RegistroConvController as ctrl">
							...
							<div class="container">
								...
								<div class="collapse navbar-collapse" id="myNavbar">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class=""><a
											href="${pageContext.request.contextPath}/registroequipo">Registro Equipo</a></li>
			...
			<div class="container">
				<div class="container">
					<form ng-submit="ctrl.submit()">
						<div id="contact">
							<h3>Registrar una nueva convocatoria</h3>
										...
										<div class="modal-header">
											...
											<p
												...
												<button type="button" class="btn btn-default"
													data-dismiss="modal"
													onclick="javascript:location.href='${pageContext.request.contextPath}/adm/'">Close</button>
											</p>
											...
											<p
												...
												<button type="button" class="btn btn-default"
													data-dismiss="modal"
													onclick="javascript:location.href='${pageContext.request.contextPath}/registroconvocatoria/'">Close</button>
											</p>
	...
	<script
		src="${pageContext.request.contextPath}/static/js/service/registroConv_service.js"></script>
	<script
		src="${pageContext.request.contextPath}/static/js/controller/registroConv_controller.js"></script>
